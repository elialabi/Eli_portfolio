...
// ─── Nav Tabs ─────────────────────────────────────────────────────────────────
function NavTabs({ active, onChange, onContactClick }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", gap: 0, flex: 1 }}>
        {tabs.map(t => (
          <button key={t} onClick={() => { if(t === "CONTACT") { onChange("STORY"); onContactClick && setTimeout(onContactClick, 50); } else onChange(t); }} style={{
...
function NameIntro() {
  ...
  return (
    <div style={{
      background: C.black, minHeight: "100svh",
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: "'Courier New', monospace",
          fontSize: "clamp(9px,2vw,10px)", color: C.pink,
  ...
  return (
    <div ref={ref} style={{
      ...
      <div style={{
        ...
        padding: "clamp(40px,7vw,100px) clamp(20px,5vw,56px) 48px",
      ...
      <div style={{
        ...
        padding: isMobile ? 24 : 56, zIndex: 1, order: isEven ? 1 : 0,
      }}>
        {stop.id === "06" ? (
          <div style={{
            fontFamily: "Georgia, serif",
...
export default function Portfolio() {
  ...
  return (
    <div style={{ background: C.paper }}>
      <Cursor />
      <NavTabs active={activeTab} onChange={setActiveTab} onContactClick={() => {
        setActiveTab("STORY");
        setTimeout(() => {
      ...
      <div style={{ paddingTop: 48 }}>
        ...
        {activeTab === "WRITING" && (
          <div style={{ background: C.paper, minHeight: "100vh", padding: "clamp(32px,6vw,64px) clamp(20px,5vw,56px) 80px" }}>
...
function ProjectsPage() {
  ...
  return (
    <div style={{
      ...
      {/* Full iframe */}
      <iframe key={demo.file} 
        src={`https://elialabi-eli-portfol-0wpb.bolt.host${demo.file}`}
